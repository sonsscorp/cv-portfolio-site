 // File: src/lib/constants.ts
  // Full path: /home/ltpho/sontl/cv-portfolio-site/src/lib/constants.ts
  ...
  export const EXPERIENCES: Experience[] = [
    ...
    },
    {
      id: '2',
      company: 'SSCORP LTD',
      position: 'Assistant to General Director',
      duration: '2002 - 2023',
      location: 'Vietnam',
      description: [
        'Led the transformation of a former joint venture into a wholly Thai-invested company specializing in Parboiled Rice, White Rice, Fish Meal and Bran products',
        'Controlled member companies: SSCORP LTD (VUNG TAU) established 2007 for fish meal production, SSCORP LTD (CAMBODIA) established 2011 for Parboiled Rice, SVN LTD established 2015 for White Rice and bran products',
        'Responsible for overall production control, construction and installation of new facilities',
        'Managed quality control standards including ISO, HACCP, and BRC compliance',
        'Oversaw global shipping logistics and international customer relations'
      ],
      technologies: [
        ...
        'ISO/HACCP/BRC Standards',
        'Logistics Management'
      ]
    },
    {
      id: '3',
      company: 'JFT RICE INDUSTRY (Joint Venture)',
      position: 'Interpreter',
      duration: '1992',
      location: 'Long An Province, Vietnam',
      description: [
        'Served as an interpreter facilitating communication between foreign engineers and local workers in the establishment of the first tapioca plant',
        'Coordinated efforts to build the factory from the ground up'
      ],
      technologies: [
    ...
    },
    {
      id: '4',
      company: 'JFT RICE INDUSTRY (Joint Venture)',
      position: 'Purchasing Manager / Production Manager',
      duration: '1994 - 2002',
      location: 'Long An Province, Vietnam',
      description: [
        'Managed raw material supply chains for the factory, ensuring continuous production and coordinating with branch in Long Xuyen, An Gang, Vietnam (1994-1995)',
        'Oversaw daily production activities, including import and export management, to ensure operational efficiency and compliance (1996-2002)'
      ],
      technologies: [
