  ...
  // Full path: /home/ltpho/sontl/cv-portfolio-site/src/components/sections/about.tsx
            ...
            >
              ...
              <div className="grid grid-cols-2 gap-4 max-w-md mx-auto">
                ...
                >
                  ...
                  <p className="text-xs text-center text-gray-600 dark:text-gray-400 mt-2">JFT Rice Industry</p>
                </motion.div>
                ...
                >
                  ...
                  <p className="text-xs text-center text-gray-600 dark:text-gray-400 mt-2">SSCORP LTD</p>
                </motion.div>
              </div>
            </motion.div>
